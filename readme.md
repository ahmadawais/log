...
[![DOWNLOADS](https://img.shields.io/npm/dt/log?label=DOWNLOADS%20%20❯&colorA=6A788D&colorB=6A788D&style=flat&style=flat)](https://www.npmjs.com/package/log) [![Learn VSCode](https://img.shields.io/badge/-VSCODE.pro%20%E2%86%92-gray.svg?colorB=6A788D&style=flat)](https://VSCode.pro/?utm_source=GitHubFOSS)
...
```js
const log = require('@mrahmadawais/log');
